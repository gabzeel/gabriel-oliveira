...
<HeaderLink href="#" currentPath="/" onclick="alert('clicked!')">
...
<div class="mockup-code w-full">
  <Code
    ...
    if (nextAttempts.length >= state.maxAttempts) {
      return {
        messages: [
          new SessionMessage<WhatTheWordMessageIntent>({
            sessionId: this.session.id,
            intent: WhatTheWordMessageIntent.Lose,
          }),
        ],
        resultState: SessionState.Finished,
        nextSession: SessionType.Welcome,
        payload: {
          ...nextState,
          state: SessionState.Finished,
          result: ScoreResult.Lose,
        },
      };
    }   
    `}
